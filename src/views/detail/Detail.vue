  ...
  export default {
    ...
    created() {
      ...
      this.getThemeTopY = debounce(() => {
        ...
        // 实现滑动与主题联动所需
        // 减去44是因为detail-nav-bar占用了44像素
        this.paramsOffsetTop.value = this.$refs.paramsRef.$el.offsetTop-44;
        this.commentssOffsetTop.value = this.$refs.commentsRef.$el.offsetTop-44;
        this.recommendsOffsetTop.value = this.$refs.recommendsRef.$el.offsetTop-44;
